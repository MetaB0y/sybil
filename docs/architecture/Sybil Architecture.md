...
flowchart TB
    ...
    subgraph exchange["Deterministic exchange"]
        ...
        WIT["BlockWitness v12<br/>private transition package"]
...
sequenceDiagram
    ...
    A->>V: Persist/export BlockWitness v12
...
| Genesis-bound ordinary signed actions | Captured orders/cancels must not cross chain domains or replay | Witness v12 retains exact envelopes; verification replays active keys, committed trading nonces, and action effects |
...
- Witness v12, committed last clearing prices and group creation identities, deposit quarantine, exact-keyspace proofs, and guest/native commitment agreement. Deployment repinning is coordinated with the epoch guest.
