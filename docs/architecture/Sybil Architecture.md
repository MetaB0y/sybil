...
flowchart TB
    ...
    subgraph exchange["Deterministic exchange"]
        ...
        WIT["BlockWitness v13<br/>private transition package"]
...
sequenceDiagram
    ...
    A->>V: Persist/export BlockWitness v13
...
| Genesis-bound signed trading actions | Captured orders/cancels/MM bundles must not cross chain domains, replay, or split atomic intent | Witness v13 retains exact envelopes; verification replays active keys, committed trading nonces, and whole-bundle effects |
...
- Witness v13, committed last clearing prices and group creation identities, deposit quarantine, exact-keyspace proofs, and guest/native commitment agreement. Deployment repinning is coordinated with the epoch guest.
