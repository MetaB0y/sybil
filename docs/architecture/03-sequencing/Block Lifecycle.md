...
flowchart LR
    ...
    SETTLE --> SEAL["7. Roots · block · witness v14"]
...
- `BlockWitness` v14: transition-complete private material for native verification, proving, DA, and recovery, including ordinary order/cancel and atomic MM-bundle lifecycle authorization, trading nonces, canonical group creation identity, and the executable two-state market lifecycle.
