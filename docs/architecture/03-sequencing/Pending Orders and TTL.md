...
4. **Settle**: after solving → fully filled orders release all reservations, partial fills adjust proportionally; orders whose expiry was the solved block release reservations and leave the book
...
- Explicit expiry means "eligible through this block height", bounded by system TTL
