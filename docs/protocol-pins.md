...
|---|---:|
| Witness format | `11` |
| Empty canonical witness length | `1743` bytes |
| Golden-vector schema | `5` |
| Canonical witness vector length | `4366` bytes |
| Canonical witness length-prefixed SHA-256 | `0x72e2816cabb2637848b0ff0eed2beee27154c1acc6f418b9559b4f477c9a2a96` |
