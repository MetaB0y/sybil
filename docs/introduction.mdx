...
<Note>
  **Pre-release.** Sybil is under active development. These docs are a work in progress and may change without notice. The matching engine, API, and oracle services currently run locally only — no public endpoints are available yet. Follow [@sybil_pm](https://x.com/sybil_pm) for launch updates.
</Note>
...
<CardGroup cols={3}>
  ...
  <Card title="Source on GitHub" icon="github" href="https://github.com/SybilPM">
