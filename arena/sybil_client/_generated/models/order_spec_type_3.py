...
from ..models.order_spec_type_3_type import OrderSpecType3Type
...
T = TypeVar("T", bound="OrderSpecType3")



@_attrs_define
class OrderSpecType3:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = OrderSpecType3Type(d.pop("type"))




        order_spec_type_3 = cls(
            limit_price_nanos=limit_price_nanos,
            market_id=market_id,
            quantity=quantity,
            type_=type_,
        ...
        order_spec_type_3.additional_properties = d
        return order_spec_type_3
