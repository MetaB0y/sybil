...
from ..models.system_event_response_type_8_type import SystemEventResponseType8Type
...
T = TypeVar("T", bound="SystemEventResponseType8")



@_attrs_define
class SystemEventResponseType8:
    ...
    variants via serde's `#[serde(tag = "type")]` shape.
        ...
        Attributes:
            ...
            remaining_quantity (int): Cancelled order's unfilled quantity. Integer share-units;
                1000 units = 1 share.
            side (str):
            type_ (SystemEventResponseType8Type):
     """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = SystemEventResponseType8Type(d.pop("type"))




        system_event_response_type_8 = cls(
            account_id=account_id,
            market_ids=market_ids,
            order_id=order_id,
            remaining_quantity=remaining_quantity,
        ...
        system_event_response_type_8.additional_properties = d
        return system_event_response_type_8
