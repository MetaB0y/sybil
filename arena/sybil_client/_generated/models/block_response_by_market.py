...
T = TypeVar("T", bound="BlockResponseByMarket")
...
class BlockResponseByMarket:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        block_response_by_market.additional_properties = additional_properties
        return block_response_by_market
