    ...
    """ Minimal market data for high-throughput dashboards (drops strings & metadata).
        ...
        Attributes:
            ...
            liquidity_band_nanos (str | Unset): Liquidity price-band width. Integer nanodollars; 1_000_000_000 = $1.
                Mirrors `MarketResponse`.
            no_price_24h_ago_nanos (None | str | Unset): Clearing NO price ~24h ago. Integer nanodollars; 1_000_000_000 =
                $1.
            ...
            yes_price_24h_ago_nanos (None | str | Unset): Clearing YES price ~24h ago. Integer nanodollars; 1_000_000_000 =
                $1.
                Prices are per-share probabilities in [0, 1e9].
