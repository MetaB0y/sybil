...
class RevokeKeyRequest:
    """ Signed request to revoke a registered signing key (SYB-60).
        ...
        Attributes:
            ...
            signer_pubkey_hex (str): Hex-encoded compressed P256 public key of the signer (any active key on
                the account may authorize revocation, including the target itself as long
                as another key remains).
            target_pubkey_hex (str): Hex-encoded compressed P256 public key (33 bytes) of the key to revoke.
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        target_pubkey_hex = self.target_pubkey_hex
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        target_pubkey_hex = d.pop("target_pubkey_hex")
