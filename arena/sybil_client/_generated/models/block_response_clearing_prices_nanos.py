...
T = TypeVar("T", bound="BlockResponseClearingPricesNanos")
...
class BlockResponseClearingPricesNanos:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        block_response_clearing_prices_nanos = cls(
        )
        ...
        block_response_clearing_prices_nanos.additional_properties = additional_properties
        return block_response_clearing_prices_nanos
