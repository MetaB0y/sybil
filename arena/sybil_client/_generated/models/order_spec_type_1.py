...
from ..models.order_spec_type_1_type import OrderSpecType1Type
...
T = TypeVar("T", bound="OrderSpecType1")



@_attrs_define
class OrderSpecType1:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = OrderSpecType1Type(d.pop("type"))




        order_spec_type_1 = cls(
            limit_price_nanos=limit_price_nanos,
            market_id=market_id,
            quantity=quantity,
            type_=type_,
        ...
        order_spec_type_1.additional_properties = d
        return order_spec_type_1
