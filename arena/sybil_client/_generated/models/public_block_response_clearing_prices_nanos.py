...
T = TypeVar("T", bound="PublicBlockResponseClearingPricesNanos")



@_attrs_define
class PublicBlockResponseClearingPricesNanos:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        public_block_response_clearing_prices_nanos = cls(
        )
        ...
        public_block_response_clearing_prices_nanos.additional_properties = additional_properties
        return public_block_response_clearing_prices_nanos
