...
from ...models.set_market_metadata_request import SetMarketMetadataRequest
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/markets/{id}/metadata".format(id=quote(str(id), safe=""),),
    }
