...
from ...models.submit_signed_mm_bundle_request import SubmitSignedMmBundleRequest
...
def _get_kwargs(
    *,
    body: SubmitSignedMmBundleRequest,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/orders/mm-bundles/signed",
    }
...
def sync_detailed(
    *,
    ...
    Args:
        body (SubmitSignedMmBundleRequest): Public signed submission of one all-or-nothing MM
            quote bundle.
