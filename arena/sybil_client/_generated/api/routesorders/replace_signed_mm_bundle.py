...
from ...models.replace_signed_mm_bundle_request import ReplaceSignedMmBundleRequest
...
def _get_kwargs(
    *,
    body: ReplaceSignedMmBundleRequest,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/orders/mm-bundles/replace/signed",
    }
...
def sync_detailed(
    *,
    ...
    Args:
        body (ReplaceSignedMmBundleRequest): Public signed atomic replacement of one active MM
            bundle revision.
