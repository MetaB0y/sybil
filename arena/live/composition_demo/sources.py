...
def extra_proposition_specs(by_short: dict[str, dict[str, Any]]) -> list[tuple[str, str, str, str, dict[str, Any], str]]:
    return [
        ...
        ("AI boom with safety backlash 2026", "AI boom backlash", "Will AI benchmarks leap while public safety incidents rise?", "Capability-and-risk composition over benchmark and incident conditions.", {"op": "AND", "args": [{"op": "K_OF_N", "k": 2, "args": [leaf(by_short, "FrontierMath > 50%"), leaf(by_short, "SWE-bench > 80%"), leaf(by_short, "ARC-AGI > 85%")]}, leaf(by_short, "AI incidents > 2")]}, "technology"),
