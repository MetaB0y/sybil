"""Simple synchronous GDELT fetcher with robust rate-limit handling.

Usage:
    cd arena && uv run python -m markets.china_visit.fetch_simple
"""
...
def run_query(name: str, query: str):
    ...
    for i, ws in enumerate(windows):
        ...
        # Progress every 4 windows (1 day with 6h windows) + save
