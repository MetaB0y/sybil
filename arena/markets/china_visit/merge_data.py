...
Usage:
    cd arena && uv run python -m markets.china_visit.merge_data
"""
...
MERGED_NAME = "china_visit_raw.json"

INPUT_FILES = [
    "china_visit_direct_raw.json",
    "china_visit_diplomacy_raw.json",
]
...
def main():
    ...
    merged = {
        "query": "MERGED: direct visit + diplomacy/trade keywords",
        "period": "2026-02-15 to 2026-03-17",
        "fetched_at": "merged",
