...
Usage:
    cd arena && uv run python -m markets.texas_primary.merge_data
"""
...
MERGED_NAME = "texas_primary_raw.json"

INPUT_FILES = [
    "texas_primary_candidates_raw.json",
    "texas_primary_race_raw.json",
    "texas_primary_trump_raw.json",
]
...
def main():
    ...
    merged = {
        "query": "MERGED: candidates + race + trump endorsement keywords",
        "period": "2026-02-10 to 2026-03-17",
        "fetched_at": "merged",
    ...
    if orig.exists():
        backup = OUT_DIR / f"{MERGED_NAME}.bak"
