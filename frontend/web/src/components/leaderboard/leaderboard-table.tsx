...
function Header({
  ...
  return (
    ...
    >
      <SortHeader col="rank" label="Rank" align="left" sort={sort} onSort={onSort} />
      <SortHeader col="trader" label="Trader" align="left" sort={sort} onSort={onSort} />
      <SortHeader col="pnl" label="PnL" align="right" sort={sort} onSort={onSort} />
      <SortHeader col="roi" label="ROI" align="right" sort={sort} onSort={onSort} />
      <SortHeader
        col="markets"
        label="Markets"
        align="right"
...
function SortHeader({
  ...
  return (
    ...
    >
      ...
      <span style={{ fontSize: 8, lineHeight: 1, opacity: active ? 1 : 0.35 }}>
        {active ? (sort!.dir === "asc" ? "▲" : "▼") : "↕"}
      </span>
    </button>
  );
