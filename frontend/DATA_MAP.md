...
| Portfolio | `/v1/accounts/{id}/portfolio`, `/v1/accounts/{id}/equity`, `/v1/accounts/{id}/orders`, `/v1/accounts/{id}/fills`, `/v1/accounts/{id}/events`, `/v1/accounts/{id}/bridge-key`, `/v1/accounts/{id}/withdrawals`, `/v1/bridge/status`, `/v1/markets`, `/v1/markets/{id}/prices/history`, `/v1/blocks/{height}` | Marks, realized PnL, history pagination, CSV export, exact L1 deposit routing key plus configured chain/vault/token and truthful quarantine guidance, current withdrawal status and ETA |
