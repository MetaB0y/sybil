...
| Market detail | `/v1/markets/{id}`, `/v1/markets`, `/v1/markets/{id}/prices/history`, `/v1/events/{event_id}/raw`, `/v1/blocks/ws` | Chart alignment, event outcome labels, live mark/age |
...
| Portfolio | `/v1/accounts/{id}/portfolio`, `/v1/accounts/{id}/equity`, `/v1/accounts/{id}/orders`, `/v1/accounts/{id}/fills`, `/v1/accounts/{id}/events`, `/v1/accounts/{id}/withdrawals`, `/v1/markets`, `/v1/markets/{id}/prices/history`, `/v1/blocks/{height}` | Marks, realized PnL, history pagination, CSV export, current withdrawal status and ETA |
