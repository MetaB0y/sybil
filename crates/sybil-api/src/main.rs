...
fn sequencer_config_from_api(config: &ApiConfig) -> SequencerConfig {
    SequencerConfig {
        ...
        fill_history_retention_secs: config.fill_history_retention_secs,
        equity_retention_secs: config.equity_retention_secs,
        account_event_retention_secs: config.account_event_retention_secs,
        max_durable_fill_rows: config.max_durable_fill_rows,
        max_durable_equity_rows: config.max_durable_equity_rows,
        max_durable_account_event_rows: config.max_durable_account_event_rows,
