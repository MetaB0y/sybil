    ...
    match event {
        ...
        matching_sequencer::SystemEvent::ClientActionAuthorized(action) => {
            let (account_id, action_name, order_id, nonce, authorization) = match action {
                ...
                matching_sequencer::ClientActionWitness::MmBundleReplace {
                    account_id,
                    orders,
                    nonce,
                    authorization,
                ...
                matching_sequencer::ClientActionWitness::MmBundleCancel {
                    account_id,
                    nonce,
                    authorization,
                    ..
                } => (*account_id, "mm_bundle_cancel", 0, *nonce, authorization),
            };
