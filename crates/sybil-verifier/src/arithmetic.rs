...
pub fn price_qty(price: Nanos, qty: Qty) -> i64 {
    notional_nanos(price, qty) as i64
}
...
mod tests {
    ...
    fn test_price_qty_basic() {
        assert_eq!(price_qty(500_000_000, shares_to_qty(100)), 50_000_000_000);
    }
    ...
    fn test_welfare_buyer() {
        ...
        let w = welfare(600_000_000, 500_000_000, shares_to_qty(100), false);
    ...
    fn test_welfare_seller() {
        ...
        let w = welfare(400_000_000, 500_000_000, shares_to_qty(100), true);
        assert_eq!(w, 10_000_000_000);
    }
