...
export SYBIL_ACTOR_CREDENTIALS_FILE="${SYBIL_ACTOR_CREDENTIALS_FILE:-/tmp/sybil-compose-smoke-actor-credentials.json}"
export SYBIL_MM_ACTOR_TOKEN="${SYBIL_MM_ACTOR_TOKEN:-compose-smoke-mm-actor-token-00000000}"
